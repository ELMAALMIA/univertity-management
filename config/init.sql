...
INSERT INTO utilisateurs (username, password, role, email) VALUES
                                                               ('chef_info', '1213456789', 'CHEF_DEPT', 'chef.info@app.com'),
                                                               ('chef_math', '1213456789', 'CHEF_DEPT', 'chef.math@app.com'),
                                                               ('surveillant1', '1213456789', 'SURVEILLANT', 'surveillant1@app.com'),
                                                               ('surveillant2', '1213456789', 'SURVEILLANT', 'surveillant2@app.com');

-- Insertion de surveillants
...
-- Réinsérer avec des mots de passe hashés
INSERT INTO utilisateurs (username, password, role, email) VALUES
                                                               ('admin', '123456789', 'ADMIN', 'admin@app.com'),
                                                               ('chef_info', '123456789', 'CHEF_DEPT', 'chef.info@app.com'),
                                                               ('chef_math', '123456789', 'CHEF_DEPT', 'chef.math@app.com'),
                                                               ('surveillant1', '123456789', 'SURVEILLANT', 'surveillant1@app.com'),
                                                               ('surveillant2', '123456789', 'SURVEILLANT', 'surveillant2@app.com');                                                              (4, 4, 8);